...
global.BUILD_FOLDER = 'public/build';
global.RELEASE_FOLDER = 'public/release';
global.TMP_FOLDER = 'public/tmp';
...
global.config = {
  paths: {
    src: {
      ...
      styles: SRC_FOLDER + '/styles/app.sass',
      stylesGlob: SRC_FOLDER + '/styles/**/*.sass',
